      ...
      <Container maxW={'3xl'}>
        <Stack as={Box} textAlign={'center'} spacing={{ base: 8, md: 14 }} py={{ base: 20, md: 36 }}>
          <Heading fontWeight={600} fontSize={{ base: '2xl', sm: '4xl', md: '6xl' }} lineHeight={'110%'}>
            Payment gateway docs <br />
            <Text as={'span'} color={'green.400'}> Build what you want!</Text>
          </Heading>
          <Text color={'gray.500'}>
            Explore a complete working sample for Payment gateway integration with Cashfree API.
