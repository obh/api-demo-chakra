  ...
  return (
    <Box bg="#fafafa">
      <Stepper activeIndex={0} stepDetails={stepData}/>
          ...
          <Grid pt={8} templateColumns="repeat(6, 1fr)" gap={4} bg="#fafafa" >
            <GridItem rowSpan={2} colSpan={3} >        
              <Box mb={4} p={4} rounded={'md'} borderColor="gray.200" backgroundColor="#ECF1F9">
                <Text>Before we start please ensure you have access to the payment gateway dashboard. 
                  Also keep your appId and secret key handy. The secret key should never be shared with anyone.
                </Text>
              </Box>
